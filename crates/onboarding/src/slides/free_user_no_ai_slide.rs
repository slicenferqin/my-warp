...
const SUBSCRIBE_ITEM_KEYS: &[&str] = &[
    "app-onboarding-free-no-ai-subscribe-item-credits",
    "app-onboarding-free-no-ai-subscribe-item-frontier-models",
    "app-onboarding-free-no-ai-subscribe-item-reload-credits",
    "app-onboarding-free-no-ai-subscribe-item-cloud-agents",
    "app-onboarding-free-no-ai-subscribe-item-indexing",
    "app-onboarding-free-no-ai-subscribe-item-warp-drive",
    "app-onboarding-free-no-ai-subscribe-item-support",
    "app-onboarding-free-no-ai-subscribe-item-cloud-storage",
];
...
impl FreeUserNoAiSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        appearance
            .ui_builder()
            .paragraph(warp_i18n::tr("app-onboarding-free-no-ai-title"))
    ...
    fn render_options(
        ...
        let agent_button = self.render_option_button(
            ...
            0,
            Icon::Code2,
            warp_i18n::tr("app-onboarding-free-no-ai-agent-title"),
            warp_i18n::tr("app-onboarding-free-no-ai-agent-description"),
        ...
        let terminal_button = self.render_option_button(
            ...
            1,
            Icon::Terminal,
            warp_i18n::tr("app-onboarding-free-no-ai-terminal-title"),
            warp_i18n::tr("app-onboarding-free-no-ai-terminal-description"),
            warp_i18n::tr("app-onboarding-free"),
            false, // badge is gray
    ...
    fn render_bottom_nav(
        ...
        let next_button = if selected_index == 1 {
            self.next_button.render(
                ...
                button::Params {
                    content: button::Content::Label(
                        warp_i18n::tr("app-onboarding-get-warping").into(),
                    ),
            ...
            self.subscribe_nav_button.render(
                ...
                button::Params {
                    content: button::Content::Label(
                        warp_i18n::tr("app-onboarding-subscribe").into(),
                    ),
                    theme: &button::themes::Primary,
                    options: button::Options {
                        on_click: Some(Box::new(|ctx, _app, _pos| {
    ...
    fn render_subscribe_panel(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = FormattedTextElement::from_str(
            warp_i18n::tr("app-onboarding-free-no-ai-subscribe-title"),
            ui_font_family,
            24.,
        )
        ...
        for item_key in SUBSCRIBE_ITEM_KEYS {
            let bullet = appearance
                .ui_builder()
                .paragraph(format!("\u{2022} {}", warp_i18n::tr(*item_key)))
                .with_style(UiComponentStyles {
                    font_size: Some(14.),
                    font_weight: Some(Weight::Normal),
                ...
                let label = Flex::row()
                    ...
                    .with_child(
                        warpui::elements::Text::new_inline(
                            warp_i18n::tr("app-onboarding-subscribe"),
