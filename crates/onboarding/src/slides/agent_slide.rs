...
impl AgentSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(warp_i18n::tr("app-onboarding-agent-title"))
        ...
        let subtitle = FormattedTextElement::from_str(
            warp_i18n::tr("app-onboarding-agent-subtitle"),
    ...
    fn render_model_section(
        ...
        let header = self.render_section_header(
            warp_i18n::tr("app-onboarding-agent-default-model"),
            appearance,
        );
    ...
    fn render_model_row(
        ...
        let hoverable_body = Hoverable::new(mouse_state, move |_| {
            ...
            let trailing: Box<dyn Element> = if is_default {
                make_pill(warp_i18n::tr("app-onboarding-recommended"))
            } else if requires_upgrade {
                make_pill(warp_i18n::tr("app-onboarding-premium"))
            } else {
                Empty::new().finish()
            };
    ...
    fn render_autonomy_workspace_enforced(&self, appearance: &Appearance) -> Box<dyn Element> {
        let header =
            self.render_section_header(warp_i18n::tr("app-onboarding-agent-autonomy"), appearance);
        ...
        let title_el = Text::new(
            warp_i18n::tr("app-onboarding-agent-team-workspace-title"),
            ui_font_family,
            14.0,
        )
        .with_color(title_color)
        ...
        let subtitle_el = Text::new(
            warp_i18n::tr("app-onboarding-agent-team-workspace-description"),
            ui_font_family,
            12.0,
        )
    ...
    fn render_autonomy_section(
        ...
        let autonomy_options: [(AgentAutonomy, String, String, MouseStateHandle); 3] = [
            (
                AgentAutonomy::Full,
                warp_i18n::tr("app-onboarding-agent-autonomy-full"),
                warp_i18n::tr("app-onboarding-agent-autonomy-full-description"),
                self.autonomy_full_mouse_state.clone(),
            ),
            (
                AgentAutonomy::Partial,
                warp_i18n::tr("app-onboarding-agent-autonomy-partial"),
                warp_i18n::tr("app-onboarding-agent-autonomy-partial-description"),
                self.autonomy_partial_mouse_state.clone(),
            ),
            (
                AgentAutonomy::None,
                warp_i18n::tr("app-onboarding-agent-autonomy-none"),
                warp_i18n::tr("app-onboarding-agent-autonomy-none-description"),
    ...
    fn render_disable_oz_section(
        ...
        let label = Text::new(
            warp_i18n::tr("app-onboarding-agent-disable-warp-agent"),
            appearance.ui_font_family(),
            14.0,
        )
        .with_color(internal_colors::text_sub(theme, background_for_text))
    ...
    fn render_upgrade_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = Text::new(
            warp_i18n::tr("app-onboarding-agent-upgrade-title"),
            ui_font_family,
            13.0,
        )
        ...
        let subtitle = Text::new(
            warp_i18n::tr("app-onboarding-agent-upgrade-description"),
            ui_font_family,
            12.0,
        )
        .with_color(internal_colors::text_sub(theme, background_for_text))
        ...
        let upgrade_button = self.upgrade_button.render(
            appearance,
            button::Params {
                content: button::Content::Label(warp_i18n::tr("app-onboarding-upgrade").into()),
    ...
    fn render_auth_prompt_bar(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let paste_token_link = ui_builder
            .link(
                warp_i18n::tr("app-onboarding-agent-click-here"),
                None,
                Some(Box::new(|ctx| {
        ...
        let text_row = Flex::row()
            ...
            .with_child(
                ui_builder
                    .span(warp_i18n::tr("app-onboarding-agent-open-page-manually"))
                    .with_style(text_styles)
                    .build()
                    .finish(),
            )
            ...
            .with_child(
                ui_builder
                    .span(warp_i18n::tr("app-onboarding-agent-paste-token-suffix"))
                    .with_style(text_styles)
                    .build()
                    .finish(),
            )
    ...
    fn render_plan_activated_toast(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let text = ui_builder
            .span(warp_i18n::tr("app-onboarding-agent-plan-activated"))
            .with_style(UiComponentStyles {
                font_color: Some(text_color),
                font_size: Some(FONT_SIZE),
                font_weight: Some(Weight::Medium),
