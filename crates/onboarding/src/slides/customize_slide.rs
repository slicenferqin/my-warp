...
impl CustomizeUISlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(warp_i18n::tr("app-onboarding-customize-title"))
        ...
        let subtitle = FormattedTextElement::from_str(
            warp_i18n::tr("app-onboarding-customize-subtitle"),
    ...
    fn render_tab_styling_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::tr("app-onboarding-customize-tab-styling"),
                is_expanded: is_selected,
                is_left_selected: ui.use_vertical_tabs,
                left_label: warp_i18n::tr("app-onboarding-customize-vertical"),
                right_label: warp_i18n::tr("app-onboarding-customize-horizontal"),
    ...
    fn render_tools_panel_card(
        ...
        if ui.tools_panel_enabled(&intention) {
            ...
            if is_agent {
                chips.push(ChipSpec {
                    label: warp_i18n::tr("app-onboarding-customize-conversation-history"),
            ...
            chips.push(ChipSpec {
                label: warp_i18n::tr("app-onboarding-customize-file-explorer"),
            ...
            chips.push(ChipSpec {
                label: warp_i18n::tr("app-onboarding-customize-global-file-search"),
            ...
            chips.push(ChipSpec {
                label: warp_i18n::tr("app-onboarding-customize-warp-drive"),
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::tr("app-onboarding-customize-tools-panel"),
                is_expanded: is_selected,
    ...
    fn render_code_review_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::tr("app-onboarding-customize-code-review"),
                is_expanded: is_selected,
