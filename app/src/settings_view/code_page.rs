...
const CODE_FEATURE_NAME_KEY: &str = "settings-code-title";
const INITIALIZATION_SETTINGS_HEADER_KEY: &str = "settings-code-initialization-settings";
const CODEBASE_INDEXING_LABEL_KEY: &str = "settings-code-codebase-indexing";
const CODEBASE_INDEX_DESCRIPTION_KEY: &str = "settings-code-index-description";
const WARP_INDEXING_IGNORE_DESCRIPTION_KEY: &str = "settings-code-warp-indexing-ignore-description";
const AUTO_INDEX_FEATURE_NAME_KEY: &str = "settings-code-auto-index-title";
const AUTO_INDEX_DESCRIPTION_KEY: &str = "settings-code-auto-index-description";
const INDEXING_DISABLED_ADMIN_TEXT_KEY: &str = "settings-code-indexing-disabled-admin";
const INDEXING_WORKSPACE_ENABLED_ADMIN_TEXT_KEY: &str = "settings-code-indexing-enabled-admin";
const INDEXING_DISABLED_GLOBAL_AI_TEXT_KEY: &str = "settings-code-indexing-disabled-global-ai";
const CODEBASE_INDEX_LIMIT_REACHED_KEY: &str = "settings-code-index-limit-reached";
...
impl CodeSubpage {
    ...
    pub fn title_key(&self) -> &'static str {
        match self {
            Self::Indexing => "settings-code-indexing-subpage-title",
            Self::EditorAndCodeReview => "settings-code-editor-review-subpage-title",
        }
    }
}
...
impl CodeSettingsPageView {
    pub fn new(ctx: &mut ViewContext<CodeSettingsPageView>) -> Self {
        ...
        let manual_add_directory_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                warp_i18n::tr("settings-code-index-new-folder"),
                SecondaryTheme,
            )
        ...
        let page = if FeatureFlag::OpenWarpNewSettingsModes.is_enabled() {
            ...
            let categories = vec![
                Category::new(
                    "settings-code-indexing-subpage-title",
                    codebase_indexing_widgets,
                ),
                Category::new(
                    "settings-code-editor-review-category",
...
impl SettingsWidget for CodePageWidget {
    ...
    fn render(
        ...
        content.add_child(self.render_settings_subtext(
            global_ai_enabled,
            CODEBASE_INDEX_DESCRIPTION_KEY,
            appearance,
        ));
        content.add_child(self.render_settings_subtext(
            global_ai_enabled,
            WARP_INDEXING_IGNORE_DESCRIPTION_KEY,
            appearance,
        ));
...
impl CodePageWidget {
    fn render_autoindexing_rows(
        ...
        if codebase_indexing_enabled && !CodebaseIndexManager::as_ref(app).can_create_new_indices()
        {
            rows.push(self.render_settings_subtext(
                false,
                CODEBASE_INDEX_LIMIT_REACHED_KEY,
                appearance,
            ));
        }
    ...
    fn render_autoindex_row(
        ...
        Container::new(
            Flex::row()
                ...
                .with_child(
                    ui_builder
                        .span(warp_i18n::tr(AUTO_INDEX_FEATURE_NAME_KEY))
    ...
    fn render_settings_subtext(
        ...
        ui_builder
            .paragraph(warp_i18n::tr(description_key))
            .with_style(UiComponentStyles {
    ...
    fn render_code_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Container::new(
            ui_builder
                .span(warp_i18n::tr(CODE_FEATURE_NAME_KEY))
                .with_style(UiComponentStyles {
                    font_size: Some(24.0),
    ...
    fn render_initialization_settings_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Container::new(
            ui_builder
                .span(warp_i18n::tr(INITIALIZATION_SETTINGS_HEADER_KEY))
                .with_style(UiComponentStyles {
                    font_size: Some(18.0),
                    font_weight: Some(Weight::Semibold),
                    font_color: Some(theme.active_ui_text_color().into()),
    ...
    fn render_codebase_indexing_toggle_row(
        ...
        let label = ui_builder
            .span(warp_i18n::tr(CODEBASE_INDEXING_LABEL_KEY))
            .with_style(UiComponentStyles {
                font_size: Some(16.0),
                font_weight: Some(Weight::Semibold),
                font_color: Some(theme.active_ui_text_color().into()),
        ...
        let disabled_tooltip_text = match admin_setting {
            AdminEnablementSetting::Enable => {
                Some(warp_i18n::tr(INDEXING_WORKSPACE_ENABLED_ADMIN_TEXT_KEY))
            }
            AdminEnablementSetting::Disable => {
                Some(warp_i18n::tr(INDEXING_DISABLED_ADMIN_TEXT_KEY))
            }
            AdminEnablementSetting::RespectUserSetting if !global_ai_enabled => {
                Some(warp_i18n::tr(INDEXING_DISABLED_GLOBAL_AI_TEXT_KEY))
            }
        ...
        content.add_child(
            Container::new(
                Flex::row()
                    ...
                    .with_child(
                        ui_builder
                            .span(warp_i18n::tr("settings-code-initialized-folders"))
                            .with_style(UiComponentStyles {
                                font_size: Some(16.0),
                                font_weight: Some(Weight::Semibold),
                                font_color: Some(theme.active_ui_text_color().into()),
        ...
        if workspaces.is_empty() {
            content.add_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .paragraph(warp_i18n::tr("settings-code-no-initialized-folders"))
                        .build()
                        .finish(),
                )
            ...
            let open_rules_button = ui_builder
                ...
                .with_text_and_icon_label(
                    warpui::ui_components::button::TextAndIcon::new(
                        ...
                        warp_i18n::tr("settings-code-open-project-rules"),
    ...
    fn render_indexing_subsection(
        ...
        column.add_child(
            ui_builder
                .span(warp_i18n::tr("settings-code-indexing-label"))
                .with_style(UiComponentStyles {
                    font_size: Some(11.0),
                    font_weight: Some(Weight::Semibold),
                    font_color: Some(theme.disabled_ui_text_color().into()),
        ...
        if let Some(index_status) = index_status {
            ...
            column.add_child(
                Flex::row()
                    ...
                    .with_child(
                        ui_builder
                            .label(warp_i18n::tr("settings-code-no-index-created"))
                            .with_style(UiComponentStyles {
        ...
        let (status_text, status_color) = if index_state.has_pending() {
            let progress_text = match index_state.sync_progress() {
                Some(SyncProgress::Discovering { total_nodes }) => {
                    let total_nodes = total_nodes.to_string();
                    Cow::from(warp_i18n::tr_with_args(
                        "settings-code-status-discovered",
                        &[("total_nodes", total_nodes.as_str())],
                    ))
                }
                Some(SyncProgress::Syncing {
                    ...
                    let completed_nodes = completed_nodes.to_string();
                    let total_nodes = total_nodes.to_string();
                    Cow::from(warp_i18n::tr_with_args(
                        "settings-code-status-syncing-progress",
                        &[
                            ("completed_nodes", completed_nodes.as_str()),
                            ("total_nodes", total_nodes.as_str()),
                        ],
                    ))
                }
                None => Cow::from(warp_i18n::tr("settings-code-status-syncing")),
            };
            ...
            let (text, color, status_icon) = if completed_successfully {
                (
                    warp_i18n::tr("settings-code-status-synced"),
                    theme.ansi_fg_green(),
                    Icon::Check,
                )
            ...
            {
                (
                    warp_i18n::tr("settings-code-status-too-large"),
                    theme.ui_warning_color(),
                    Icon::AlertTriangle,
                )
            } else if index_state.has_synced_version() {
                (
                    warp_i18n::tr("settings-code-status-stale"),
                    theme.nonactive_ui_detail().into_solid(),
                    Icon::ClockRefresh,
                )
            } else {
                (
                    warp_i18n::tr("settings-code-status-failed"),
            ...
            (
                Cow::from(warp_i18n::tr("settings-code-status-no-index-built")),
    ...
    fn render_lsp_servers_subsection(
        ...
        content.add_child(
            ui_builder
                .span(warp_i18n::tr("settings-code-lsp-servers-label"))
                .with_style(UiComponentStyles {
                    font_size: Some(11.0),
                    font_weight: Some(Weight::Semibold),
                    font_color: Some(theme.disabled_ui_text_color().into()),
    ...
    fn render_suggested_lsp_server_row(
        ...
        let (description, is_installing) = match &repo_status {
            Some(LspRepoStatus::DisabledAndInstalled { .. }) => {
                (warp_i18n::tr("settings-code-lsp-installed"), false)
            }
            Some(LspRepoStatus::Installing { .. }) => {
                (warp_i18n::tr("settings-code-lsp-installing"), true)
            }
            Some(LspRepoStatus::CheckingForInstallation) => {
                (warp_i18n::tr("settings-code-lsp-checking"), true)
            }
            _ => (warp_i18n::tr("settings-code-lsp-available-download"), false),
        };
        ...
        if is_failed {
            if let Some(server_handle) = server_model.cloned() {
                ...
                let restart_button = ui_builder
                    ...
                    .with_text_label(warp_i18n::tr("settings-code-lsp-restart-server"))
                    .build()
                    .with_cursor(Cursor::PointingHand)
                    .on_click(move |ctx, _, _| {
        ...
        #[cfg(not(target_family = "wasm"))]
        {
            ...
            if has_logs {
                ...
                let view_logs_button = ui_builder
                    ...
                    .with_text_label(warp_i18n::tr("settings-code-lsp-view-logs"))
                    .build()
                    .with_cursor(Cursor::PointingHand)
                    .on_click(move |ctx, _, _| {
                ...
                match server.state() {
                    LspState::Available { .. } if !server.has_pending_tasks() => (
                        AnsiColorIdentifier::Green
                            ...
                            .into(),
                        warp_i18n::tr("settings-code-lsp-available"),
                    ),
                    LspState::Starting | LspState::Available { .. } => (
                        AnsiColorIdentifier::Yellow
                            .to_ansi_color(&theme.terminal_colors().normal)
                            .into(),
                        warp_i18n::tr("settings-code-lsp-busy"),
                    ),
                    LspState::Failed { .. } => (
                    ...
                    LspState::Stopped { .. } | LspState::Stopping { .. } => (
                        ...
                        warp_i18n::tr("settings-code-lsp-stopped"),
                    ),
                }
            }
            None => (
                theme.disabled_ui_text_color().into_solid(),
                warp_i18n::tr("settings-code-lsp-not-running"),
            ),
        }
    }
}
...
impl SettingsWidget for CodeSubpageHeaderWidget {
    ...
    fn render(
        ...
        build_sub_header(appearance, warp_i18n::tr(self.title_key), None)
...
impl SettingsWidget for CodebaseIndexingCategorizedWidget {
    ...
    fn render(
        ...
        content.add_child(render_body_item::<CodeSettingsPageAction>(
            warp_i18n::tr(CODEBASE_INDEXING_LABEL_KEY),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
            toggle_element,
            Some(warp_i18n::tr(CODEBASE_INDEX_DESCRIPTION_KEY)),
        ));
        ...
        if global_ai_enabled && codebase_context_enabled {
            ...
            content.add_child(render_body_item::<CodeSettingsPageAction>(
                warp_i18n::tr(AUTO_INDEX_FEATURE_NAME_KEY),
                None,
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
                appearance,
                ui_builder
                    ...
                    .finish(),
                Some(warp_i18n::tr(AUTO_INDEX_DESCRIPTION_KEY)),
            ));

            if !CodebaseIndexManager::as_ref(app).can_create_new_indices() {
                content.add_child(
                    ui_builder
                        .paragraph(warp_i18n::tr(CODEBASE_INDEX_LIMIT_REACHED_KEY))
                        .with_style(UiComponentStyles {
...
impl SettingsWidget for CodeReviewPanelToggleWidget {
    ...
    fn render(
        ...
        render_body_item::<CodeSettingsPageAction>(
            warp_i18n::tr("settings-code-show-code-review-button"),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
            appearance
                ...
                .finish(),
            Some(warp_i18n::tr(
                "settings-code-show-code-review-button-description",
            )),
        )
    }
}
...
impl SettingsWidget for CodeReviewDiffStatsToggleWidget {
    ...
    fn render(
        ...
        render_body_item::<CodeSettingsPageAction>(
            warp_i18n::tr("settings-code-show-diff-stats"),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
            appearance
                ...
                .finish(),
            Some(warp_i18n::tr("settings-code-show-diff-stats-description")),
        )
    }
}
...
impl SettingsWidget for ProjectExplorerToggleWidget {
    ...
    fn render(
        ...
        render_body_item::<CodeSettingsPageAction>(
            warp_i18n::tr("settings-code-project-explorer"),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
            appearance
                ...
                .finish(),
            Some(warp_i18n::tr("settings-code-project-explorer-description")),
        )
    }
}
...
impl SettingsWidget for GlobalSearchToggleWidget {
    ...
    fn render(
        ...
        render_body_item::<CodeSettingsPageAction>(
            warp_i18n::tr("settings-code-global-file-search"),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
            appearance
                ...
                .finish(),
            Some(warp_i18n::tr(
                "settings-code-global-file-search-description",
            )),
        )
    }
}
