...
impl ChangelogSectionView {
    pub fn new(
        ...
        Self {
            ...
            changelog_fetch_error: create_formatted_text_from_string(warp_i18n::tr(
                "resource-center-changelog-fetch-error",
            )),
            changelog_loading: create_formatted_text_from_string(warp_i18n::tr(
    ...
    fn section_link(&self, appearance: &Appearance) -> Option<Box<dyn Element>> {
        Some(
            appearance
                .ui_builder()
                .link(
                    warp_i18n::tr("resource-center-read-all-changelogs"),
